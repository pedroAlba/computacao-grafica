...
public class CanvasCommand extends Canvas {
    ...
    /**
     * Controla a primeira exibição. public void setFirstDisplay(int pos) { firstDisplay[pos] =
     * true; if(firstDisplay[0] && firstDisplay[1]) { displayAll = true; //
     * frame.getWorld().activeDisplay(); frame.getScreen().activeDisplay(); if(glDrawable != null)
     * glDrawable.display(); } }
     */
